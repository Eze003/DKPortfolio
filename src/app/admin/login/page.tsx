...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_-10%,rgba(8,134,253,0.25),transparent)] pointer-events-none" />

      <motion.div
        initial={{ opacity: 0, y: 24 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="relative w-full max-w-md rounded-[32px] p-2 border border-[#222] bg-black shadow-[0_0_80px_rgba(8,134,253,0.3)]"
      >
        <div className="rounded-3xl border border-primary-500/30 bg-[#050505] shadow-[inset_0_0_40px_rgba(8,134,253,0.10)] p-10">
          {/* Logo/Brand */}
          <div className="flex flex-col items-center justify-center mb-10">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center text-white font-black text-3xl shadow-[0_0_40px_rgba(8,134,253,0.5)] mb-4">
              M
            </div>
