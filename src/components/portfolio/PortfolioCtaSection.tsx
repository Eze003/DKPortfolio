...
export default function PortfolioCtaSection() {
  return (
    <section className="bg-[#050505] px-6 pb-24 pt-6 sm:px-8 lg:px-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center rounded-4xl border border-[#0886FD]/20 bg-[radial-gradient(circle_at_top,rgba(8,134,253,0.15),transparent_50%),linear-gradient(135deg,#0d0d0d,#080808)] px-6 py-14 text-center shadow-[0_24px_80px_rgba(0,0,0,0.3)] sm:px-10">
